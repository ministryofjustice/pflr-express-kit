      ...
      if (req.method === 'POST') {
        ...
        blocksFound.forEach(el => {
          ...
          if (block.multiple_counter) {
            if (getFieldValue(block.multiple_counter) === undefined) {
              req.body[block.multiple_counter] = block.multiple_start
              setFieldValue(block.multiple_counter, block.multiple_start)
            }
          }
          if (noValidation) {
            return
