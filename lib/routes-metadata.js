...
let { getBlock, getBlockProp, getBlockRaw, setBlock, getKeys, destroyBlock } = blockMethods
...
if (development) {
  ...
  router.post('/admin/block/:block', (req, res) => {
    ...
    if (block) {
      ...
      if (req.body.cloneId && req.body.clone) {
        blockId = req.body.cloneId
        block._id = blockId
